    ...
    while(True):  
        ...
        if (index==0):
            try:
                ...
                engine = pyttsx3.init()
                engine.say("Enter a valid temperature between -400 and 215")
                engine.runAndWait()
            except:
        ...
        if (index==1):        
            try:
                ...
                engine = pyttsx3.init()
                engine.say("Enter a valid reading between 70-190")
                engine.runAndWait()
        ...
        if (index==2):        
            try:
                ...
                engine = pyttsx3.init()
                engine.say("Enter a valid reading between 40-100")
                engine.runAndWait() 
        ...
        if (index==3):                
            try:
                ...
                engine = pyttsx3.init()
                engine.say("Enter a valid pulse rate between 70-100")
                engine.runAndWait() 
        ...
        if (index==4):            
            try:
                ...
                engine = pyttsx3.init()
                engine.say("Enter a valid pain level between 1 to 10")
                engine.runAndWait() 
...
engine.say("Here's the patient summary")
print("The patient's recorded temperature is "+trans[0])
engine.say("The patient's recorded temperature is "+trans[0])
print("The patient's recorded systolic blood pressure is "+trans[1])
engine.say("The patient's recorded systolic blood pressure is "+trans[1])
print("The patient's recorded diastolic blood pressure is "+trans[2])
engine.say("The patient's recorded diastolic blood pressure is "+trans[2])
print("The patient's recorded pulse rate is "+trans[3])
engine.say("The patient's recorded pulse rate is "+trans[3])
print("The patient's recorded pain level is "+trans[4])
engine.say("The patient's recorded pain level is "+trans[4])
engine.runAndWait()
